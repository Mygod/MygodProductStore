<%@ Page Title="FallingPlatform 元素 - Edge关卡XML参考指南" Language="C#" MasterPageFile="~/Online/Edge/Edge.master" AutoEventWireup="true" CodeBehind="FallingPlatform.aspx.cs" Inherits="Mygod.Website.ProductStore.Online.Edge.FallingPlatform" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Body" runat="server">
    ...
    <tr>
        ...
        <td>可选，默认为20。表示压过到掉落之间间隔的分秒（0.1秒）数。</td>
    </tr>
</asp:Content>
