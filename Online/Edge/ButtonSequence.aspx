<%@ Page Title="ButtonSequence 元素 - Edge关卡XML参考指南" Language="C#" MasterPageFile="~/Online/Edge/Edge.master" AutoEventWireup="true" CodeBehind="ButtonSequence.aspx.cs" Inherits="Mygod.Website.ProductStore.Online.Edge.ButtonSequence" %>
