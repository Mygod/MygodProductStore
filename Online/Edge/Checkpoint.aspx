...
<asp:Content ID="Content3" ContentPlaceHolderID="Description" runat="server">
    Checkpoint（停留点），若在方块经过这一点（或这一范围）后死亡（或在菜单中选择last checkpoint），会恢复到这一点，并恢复到达这一点时的状态。在settings.ini中设置show_checkpoint_effect = true后会在经过停留点时方块变白一次。
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="Body" runat="server">
    ...
    <tr>
        ...
        <td>可选，默认为0,0。使方块的坐标与停留点坐标之差的绝对值小于此值时也认为是到达了停留点。（换言之可以使停留点变成一个矩形）</td>
    </tr>
</asp:Content>
