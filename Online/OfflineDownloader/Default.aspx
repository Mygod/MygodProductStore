...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <div>离线下载器同样支持同时下载多个文件！在下面的窗口中粘贴上所有你要下载的地址然后点击那个神奇的按钮，稍等片刻后服务器就会返回下载链接。点击<a href="Fetch.aspx">这里</a>看看下载状态，当当前任务总数变为0/x时表示全部下载完成，复制以下的下载链接即可开始下载！</div>
    <div>想要销毁任务？把你得到的地址中的Fetch改为Destroy然后打开即可！</div>
    <div><asp:TextBox ID="LinkBox" runat="server" TextMode="MultiLine" CssClass="link-box"></asp:TextBox></div>
