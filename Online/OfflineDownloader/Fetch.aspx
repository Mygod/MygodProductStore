...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <ol>
        ...
        <li>我可以关掉这个页面吗？它太占内存了。<br />
            是的，但是我们<strong>极其不推荐你这样做</strong>，因为你关闭页面后服务器就可以休息，服务器一旦休息你的任务就有可能会被咔嚓。如果你坚持这么做，记住<strong>保存好这个页面的地址</strong>，并<strong>常回来看看</strong>，尤其是要赶在任务被咔嚓或被彻底咔嚓之前回来把你的东西下载下来。</li>
        <li>我使用这厮下载的文件可以被别人下载到吗？网站管理员能下载到吗？<br />
            只要别人不知道这个页面的地址，即使是网站管理员也下载不到。</li>
        <li>我怎么知道任务被咔嚓或彻底咔嚓了？<br />
            看看上面显示的“当前状态”，如果显示已被咔嚓或是有“错误……thread……aborted”的字样，那么就是被咔嚓了，请销毁后重新开始下载；如果当前状态显示“文件消失”字样，则你的任务或者被彻底咔嚓，或者服务器反应慢，请刷新一下试试，如果被彻底咔嚓，你无须销毁，只要重新下载一下就行了。</li>
        <li>下载完成后我怎么下载文件？<br />
