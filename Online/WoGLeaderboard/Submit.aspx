...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <ol>
        ...
        <li>如果你认为你先拿到这一个记录，你有以下三种选择：<br />
            ...
            ③与纪录保持者辩论直到他松口。如果你有第二个方法的证明或在第三个方法中双方达成协议，可以在下面留言申诉。</li>
    </ol>
    <div>&nbsp;</div>
    ...
    <ol><li>下载并安装WoGModifier，并加载你的原版游戏。</li>
        <li>点击工具 - 选项，选中“启用控制台调试器”。<br />
            <img src="http://i1264.photobucket.com/albums/jj483/MygodStudio/ProductStore/screenshot-step-1.png~original" /></li>
        <li>双击你的原版游戏（或点击右击 - 运行游戏），此时你就会看到控制台调试器出现。<br />
            <img src="http://i1264.photobucket.com/albums/jj483/MygodStudio/ProductStore/screenshot-step-2.png~original" /></li>
        <li>去打你的纪录吧！不要关闭这窗口，这窗口对游戏完全没影响，真的。</li>
        <li>打完以后你可以找到如下图中的字样：time&nbsp; stat: old=xxx new=yyy。这里的yyy就是你的时间了，截图下来即可！<br />
            <img src="http://i1264.photobucket.com/albums/jj483/MygodStudio/ProductStore/screenshot-step-3.png~original" /></li>
        <li>如果很不幸，你的OCD速度比你的Goal速度慢，那么time&nbsp; stat不会显示。没关系，你可以继续往下找，找到HTTP POST这一行，里面有一个time=yy，这个yy就是你的秒数了！你的截图应该要从?balls=开始一直到time=yy&amp;，一来可以看到你玩的是哪一关，其次可以用来证明你玩到的是（举例子）60秒而不是600秒。<br />
            ...
            <img src="http://i1264.photobucket.com/albums/jj483/MygodStudio/ProductStore/screenshot-step-4.png~original" /></li>
